function index=SREC_LSTM_realtime()
clear all;
clc;
close all;
 
C={'Samsung_founder_is.wav', 'Where_is_Samsung_located.wav', 'Greet_everyone.wav', 'Where_are_we.wav','Invite_Dr_Aravind.wav', 'What_is_your_name.wav', 'The_main_competitor_of_Samsung.wav', 'Send_email_to_Praveen.wav', 'Turn_on_the_camera.wav', 'Conclude_the_event.wav','what_is_the_OS_of_Samsung.wav','Tell_the_RAM_size_of_S6.wav','S6_was_released_in.wav','The_cost_of_S6_is.wav','Do_you_own_S6.wav','Flights_to_Boston_today.wav','Next_flight_to_Perth.wav','Is_flight_AK021_delayed.wav','Send_message_to_Dr.Mun.wav','Are_seats_available.wav'};
D={'Samsung founder is', 'Where is Samsung located', 'Greet everyone', 'Where are we','Invite Dr Aravind', 'What is your name', 'The main Competitor of Samsung', 'Send email to Praveen', 'Turn on the camera', 'Conclude the event','what is the OS of Samsung','Tell the RAM size of S6','S6 was released in','The cost of S6 is','Do you own S6','Flights to Boston today','Next flight to Perth','Is flight AK021 delayed','Send message to Dr.Mun','Are seats available'};
index=0;
% disp( 'The words are: ')
% for y=1:length(C)
% disp (D{y});
